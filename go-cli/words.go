...
func registerSDKWords(r *eng.Registry, client *sdk.IstoriesSDK) {
...
func runOp(client *sdk.IstoriesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
