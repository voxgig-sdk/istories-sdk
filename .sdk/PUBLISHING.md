...
|---|---|---|
| `ts/` | @voxgig-sdk/istories-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/istories-sdk \
      --repository voxgig-sdk/istories-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/istories-sdk` shows it, and
`npm trust revoke @voxgig-sdk/istories-sdk --id=<id>` removes it.
