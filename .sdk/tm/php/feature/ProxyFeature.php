...
class IstoriesProxyFeature extends IstoriesBaseFeature
{
    ...
    public function init(IstoriesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IstoriesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
