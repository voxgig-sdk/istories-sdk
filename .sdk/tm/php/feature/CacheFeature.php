...
class IstoriesCacheFeature extends IstoriesBaseFeature
{
    ...
    private function _through(IstoriesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
