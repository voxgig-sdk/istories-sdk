...
// Istories SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IstoriesTestFeature extends IstoriesBaseFeature
{
    ...
    public function init(IstoriesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IstoriesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IstoriesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IstoriesContext $ctx, $op, $args): array
    {
