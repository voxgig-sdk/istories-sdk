...
// Istories SDK clienttrack feature
...
class IstoriesClienttrackFeature extends IstoriesBaseFeature
{
    ...
    public function PostConstruct(IstoriesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Istories-SDK';
