...
class IstoriesGraphql
{
    ...
    // equivalent.
    public static function body(IstoriesContext $ctx): mixed
    {
    ...
    public static function errors(IstoriesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
