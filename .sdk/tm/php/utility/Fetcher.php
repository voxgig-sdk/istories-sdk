...
// Istories SDK utility: fetcher

class IstoriesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IstoriesSDK/1.0)';
    ...
    public static function call(IstoriesContext $ctx, string $fullurl, array $fetchdef): array
    {
