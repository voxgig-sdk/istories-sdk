...
// Istories SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IstoriesMakeRequest
{
    public static function call(IstoriesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IstoriesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IstoriesResponse($fetched);
        } else {
