...
from projectname_sdk import IstoriesSDK
from projectname_sdk.core.spec import IstoriesSpec
from projectname_sdk.core.result import IstoriesResult
from projectname_sdk.core.response import IstoriesResponse
from projectname_sdk.core.operation import IstoriesOperation
from projectname_sdk.core.error import IstoriesError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IstoriesBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = IstoriesSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = IstoriesSDK.test(None, None)
        ...
        class TestInitFeature(IstoriesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IstoriesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IstoriesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IstoriesSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IstoriesSDK.test(None, setup_opts)
