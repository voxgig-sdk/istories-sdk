...
from projectname_sdk.core.control import IstoriesControl
...
class IstoriesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, IstoriesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IstoriesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IstoriesError(code, msg, self)
