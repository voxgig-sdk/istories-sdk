...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = IstoriesOmni.make_runner(TEST_JSON_FILE, IstoriesSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : IstoriesOmni.errify(err)
    end
