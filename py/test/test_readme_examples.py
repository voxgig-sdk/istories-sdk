# Istories SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IstoriesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IstoriesSDK(...) and IstoriesSDK.test(...) become
#      IstoriesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "istories_sdk"
_SDK_CLASS = "IstoriesSDK"
