...
from istories_sdk.utility import register

# Load features
from istories_sdk.feature.base_feature import IstoriesBaseFeature
from istories_sdk.features import _has_feature, _make_feature
...
class IstoriesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = IstoriesUtility()
        self._utility = utility

        from istories_sdk.config import shared_config
    ...
    def get_utility(self):
        return IstoriesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IstoriesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def New(self, data=None) -> "NewEntity":
        ...
        from istories_sdk.entity.new_entity import NewEntity
        return NewEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "IstoriesSDK":
        if sdkopts is None:
            sdkopts = {}
