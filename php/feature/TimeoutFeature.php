...
class IstoriesTimeoutFeature extends IstoriesBaseFeature
{
    ...
    private function _with_timeout(IstoriesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IstoriesContext $_ctx, float $ms): void
    {
        $client = $this->client;
