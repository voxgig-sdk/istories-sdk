...
// Istories SDK streaming feature
...
class IstoriesStreamingFeature extends IstoriesBaseFeature
{
    ...
    private function _iterate(IstoriesResult $result): \Generator
    {
    ...
    private function _streamable(IstoriesContext $ctx): bool
    {
