...
// Istories SDK ratelimit feature
...
class IstoriesRatelimitFeature extends IstoriesBaseFeature
{
    ...
    private function _acquire(IstoriesContext $ctx): void
    {
    ...
    private function _track(IstoriesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
