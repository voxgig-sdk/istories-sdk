...
class IstoriesRbacFeature extends IstoriesBaseFeature
{
    ...
    private function _required(IstoriesContext $ctx): ?string
    {
    ...
    private function _reject(IstoriesContext $ctx, string $required): void
    {
    ...
    private function _track(IstoriesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
