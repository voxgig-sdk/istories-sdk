...
class IstoriesNetsimFeature extends IstoriesBaseFeature
{
    ...
    private function _simulate(IstoriesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IstoriesContext $ctx, array $applied): void
    {
        $client = $this->client;
