...
require_once __DIR__ . '/../istories_sdk.php';
...
{
    private static function utility(): IstoriesUtility
    {
        return new IstoriesUtility();
    }
    ...
    private static function ctx(array $over = []): IstoriesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IstoriesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IstoriesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IstoriesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IstoriesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IstoriesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IstoriesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IstoriesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IstoriesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IstoriesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IstoriesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IstoriesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IstoriesResponse([]),
            'result' => new IstoriesResult([]),
        ]);
        [, $err] = IstoriesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IstoriesSpec([]),
            'response' => null,
            'result' => new IstoriesResult([]),
        ]);
        [, $err] = IstoriesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IstoriesSpec(['step' => 's']),
            'response' => new IstoriesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IstoriesResult([]),
        ]);
        [, $err] = IstoriesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IstoriesSpec(['step' => 's']),
            'response' => new IstoriesResponse(self::resp(200, ['v' => 1])),
            'result' => new IstoriesResult([]),
        ]);
        [, $err] = IstoriesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IstoriesSpec(['step' => 's']),
            'response' => new IstoriesResponse(self::resp(200, ['v' => 2])),
            'result' => new IstoriesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IstoriesMakeResponse::call($ctx);
    ...
    {
        $preset = new IstoriesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IstoriesSpec([]),
            'response' => new IstoriesResponse([]),
            'result' => new IstoriesResult([]),
        ...
        [$got, $err] = IstoriesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IstoriesResult([])]);
        [, $err] = IstoriesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IstoriesSpec([]), 'result' => null]);
        [, $err] = IstoriesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IstoriesSpec(['step' => 's']),
            'result' => new IstoriesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IstoriesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IstoriesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IstoriesSpec(['step' => 's']),
            'result' => new IstoriesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IstoriesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IstoriesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IstoriesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IstoriesSpec([]),
            'result' => new IstoriesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IstoriesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IstoriesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IstoriesError('boom', 'boom');
        $utility->fetcher = function (IstoriesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IstoriesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IstoriesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IstoriesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IstoriesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IstoriesResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IstoriesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IstoriesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IstoriesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IstoriesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IstoriesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IstoriesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IstoriesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IstoriesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IstoriesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IstoriesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IstoriesResult(['ok' => false])]);
        $this->expectException(IstoriesError::class);
        IstoriesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IstoriesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IstoriesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IstoriesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IstoriesBaseFeature();
        $b = new IstoriesBaseFeature();
        IstoriesFeatureAdd::call($ctx, $a);
        IstoriesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IstoriesBaseFeature
    {
        $f = new IstoriesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IstoriesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IstoriesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IstoriesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IstoriesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IstoriesResponse(['headers' => null]),
            'result' => new IstoriesResult([]),
        ]);
        IstoriesResultHeaders::call($ctx);
