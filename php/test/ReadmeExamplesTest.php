...
// Istories SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IstoriesSDK::test)
...
{
    private const SDK_CLASS = 'IstoriesSDK';
    ...
    private const SDK_BASE = 'istories_sdk';
