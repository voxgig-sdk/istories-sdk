...
class IstoriesTestRunner
{
    ...
    {
        $live = self::getenv('ISTORIES_TEST_LIVE');
        $override = self::getenv('ISTORIES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ISTORIES_TEST_EXPLAIN');
...
class_alias('IstoriesTestRunner', 'Runner');
class_alias('IstoriesHelpers', 'Helpers');
