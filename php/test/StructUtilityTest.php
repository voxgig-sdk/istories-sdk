...
// Istories SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IstoriesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IstoriesOmni::structfix($now, Struct::undef()))
                        !== json_encode(IstoriesOmni::structfix($val, Struct::undef()))) {
