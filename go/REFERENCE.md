# Istories Golang SDK Reference

Complete API reference for the Istories Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *IstoriesSDK`
...
#### `New(data map[string]any) IstoriesEntity`
