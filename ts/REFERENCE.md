# Istories TypeScript SDK Reference

Complete API reference for the Istories TypeScript SDK.
...
```ts
new IstoriesSDK(options?: object)
```
...
#### `IstoriesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `IstoriesSDK` instance in test mode.
...
Return the parent `IstoriesSDK` instance.
