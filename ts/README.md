# Istories TypeScript SDK



The TypeScript SDK for the Istories API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.New()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `IstoriesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `IstoriesSDK.test(testopts?, sdkopts?)` | `IstoriesSDK` | Create a test-mode client. |
...
| `client` | `client(): IstoriesSDK` | Return the parent SDK client. |
