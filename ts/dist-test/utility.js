...
function envOverride(m) {
    if ('TRUE' === process.env.ISTORIES_TEST_LIVE ||
        'TRUE' === process.env.ISTORIES_TEST_OVERRIDE) {
    ...
    m.ISTORIES_TEST_EXPLAIN = process.env.ISTORIES_TEST_EXPLAIN || m.ISTORIES_TEST_EXPLAIN;
    return m;
}
