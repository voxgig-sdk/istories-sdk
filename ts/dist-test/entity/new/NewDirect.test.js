...
(0, node_test_1.describe)('NewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-new', async (t) => {
        ...
        const result = await client.direct({
            path: 'page-data/news/page-data.json',
            method: 'GET',
            params,
            query,
        });
...
function liveScenariosActive() { return false && process.env.ISTORIES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IstoriesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ISTORIES_TEST_NEW_ENTID'];
    ...
    const client = new __1.IstoriesSDK({
        base: 'http://localhost:8080',
