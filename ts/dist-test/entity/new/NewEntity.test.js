...
(0, node_test_1.describe)('NewEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('ISTORIES_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.IstoriesSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.IstoriesSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.IstoriesSDK(merge([
