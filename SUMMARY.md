...
Results: Successful response containing news data.
...
| --- | --- | --- | --- |
| New | `list` | `GET /page-data/news/page-data.json` | See reference |

## Connect to the API

- Production server: `https://istories.media`
...
- `istories_list`: List records for an entity. Supported entities: `new`.
- `istories_load`: Load one record for an entity. No active entity supports this operation.
