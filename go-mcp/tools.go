...
type Args struct {
	Entity string         `json:"entity" jsonschema:"new"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IstoriesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "istories_list",
		Description: "List records from Istories. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "istories_load",
		Description: "Load a single record from Istories. " +
...
func runOp(client *sdk.IstoriesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IstoriesSDK, name string) (sdk.IstoriesEntity, error) {
