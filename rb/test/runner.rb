...
module IstoriesTestRunner
  ...
  def self.env_override(m)
    live = getenv("ISTORIES_TEST_LIVE")
    override = getenv("ISTORIES_TEST_OVERRIDE")
    ...
    explain = getenv("ISTORIES_TEST_EXPLAIN")
    m["ISTORIES_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = IstoriesTestRunner
Helpers = IstoriesHelpers
Vs = VoxgigStruct
