...
local IstoriesSDK = {}
IstoriesSDK.__index = IstoriesSDK
...
IstoriesSDK._make_feature = _make_feature


function IstoriesSDK.new(options)
  local self = setmetatable({}, IstoriesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IstoriesSDK:options_map()
...
function IstoriesSDK:get_utility()
  return Utility.copy(self._utility)
end


function IstoriesSDK:get_root_ctx()
  return self._rootctx
end


function IstoriesSDK:prepare(fetchargs)
...
function IstoriesSDK:direct(fetchargs)
...
-- by passing it.
function IstoriesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IstoriesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "IstoriesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function IstoriesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IstoriesSDK.new(sdkopts)
  sdk.mode = "test"
